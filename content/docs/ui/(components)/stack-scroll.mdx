---
title: Stack Scroll
description: A scroll bar that show cases your technical skills.
preview: true
---

<ComponentTabs name="stack-scroll-demo" />
...
```package-install
npx shadcn@latest add "https://rei-ui-lake.vercel.app/r/stack-scroll"
```
...
<Steps>
  ...
  <Step>
    ...
    <ComponentSource name="stack-scroll" />
